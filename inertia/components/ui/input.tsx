	...
	return (
		<InputPrimitive
			...
			className={cn(
				...
				"focus-visible:ring-primary focus-visible:ring-1 ring-0 aria-invalid:ring-0 aria-[invalid=false]:focus-visible:shadow-primary",
				"data-[invalid=true]:text-black aria-invalid:text-black",
				className,
			)}
			{...props}
		/>
